...
class GithubInstallation(Base):
    ...
    unlink_requested_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    unlinked_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    unlinked_by_user_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("users.id"), nullable=True)
